...
const CurrentSectionId = Context.Sections.siteHeaderList
const CurrentSection = Crsl.Items[CurrentSectionId]
const CurrentState = {}

const tbl =  new $fgta5.Gridview('siteHeaderList-tbl')
const pnl_search = document.getElementById('siteHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('siteHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing siteHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('siteHeaderList-txt_searchtext')
		const btn_load = document.getElementById('siteHeaderList-btn_gridload')
		...
		// siteHeaderList-ext.mjs, export function initSearchParams(self, SearchParams) {} 
...
async function openRow(self, tr) {
	...
	const siteHeaderEdit = self.Modules.siteHeaderEdit
	siteHeaderEdit.clearForm(self, 'loading...')

	try {
		setCurrentRow(self, tr)
		CurrentState.SelectedRow.keyValue = keyvalue
		CurrentState.SelectedRow.key = key
		await siteHeaderEdit.openSelectedData(self, {key:key, keyvalue:keyvalue})

		// matikan atau nyalakan button prev/next sesuai kondisi
		setPagingButton(self, siteHeaderEdit)
...
function tbl_cellclick(self, evt) {
	...
	const siteHeaderEdit = self.Modules.siteHeaderEdit
	siteHeaderEdit.Section.show({}, (evt)=>{
		openRow(self, tr)
	})
...
async function tbl_loadData(self, params={}) {
	console.log('loading siteHeader data')
	console.log(params)
