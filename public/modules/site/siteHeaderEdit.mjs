...
async function  frm_locked(self, evt) {
	...
	// trigger lock event di sitebrand
	self.Modules.siteSitebrandList.headerLocked(self)
	self.Modules.siteSitebrandEdit.headerLocked(self)
...
async function  frm_unlocked(self, evt) {
	...
	// trigger unlock event di sitebrand
	self.Modules.siteSitebrandList.headerUnlocked(self)
	self.Modules.siteSitebrandEdit.headerUnlocked(self)	
