...
import * as siteSitebrandList from './siteSitebrandList.mjs' 
import * as siteSitebrandEdit from './siteSitebrandEdit.mjs' 
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				...
				siteSitebrandList.init(self, args), 
				siteSitebrandEdit.init(self, args), 
			...
			const modNameList = ['siteHeaderEdit', 'siteSitebrandEdit']
