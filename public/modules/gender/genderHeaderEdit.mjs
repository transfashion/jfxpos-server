...
export async function init(self, args) {
	...
	// export async function genderHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'genderHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function genderHeaderEdit_isEditDisabled(self, data)
