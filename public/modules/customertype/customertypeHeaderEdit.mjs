...
import * as Ext from './customertype-ext.mjs'
...
const CurrentSectionId = Context.Sections.customertypeHeaderEdit
const CurrentSection = Crsl.Items[CurrentSectionId]
const Source = Context.Source
const CurrentState = {}

const TitleWhenNew = 'New Customer Type'
const TitleWhenView = 'View Customer Type'
const TitleWhenEdit = 'Edit Customer Type'
const EditModeText = 'Edit'
const LockModeText = 'Lock'

const btn_edit = new $fgta5.ActionButton('customertypeHeaderEdit-btn_edit')
const btn_save = new $fgta5.ActionButton('customertypeHeaderEdit-btn_save')
const btn_new = new $fgta5.ActionButton('customertypeHeaderEdit-btn_new', 'customertypeHeader-new')
const btn_del = new $fgta5.ActionButton('customertypeHeaderEdit-btn_delete')
const btn_reset = new $fgta5.ActionButton('customertypeHeaderEdit-btn_reset')
const btn_prev = new $fgta5.ActionButton('customertypeHeaderEdit-btn_prev')
const btn_next = new $fgta5.ActionButton('customertypeHeaderEdit-btn_next')


const btn_recordstatus = document.getElementById('customertypeHeader-btn_recordstatus')
const btn_logs = document.getElementById('customertypeHeader-btn_logs')
const btn_about = document.getElementById('customertypeHeader-btn_about')

const frm = new $fgta5.Form('customertypeHeaderEdit-frm');
const obj_customertype_id = frm.Inputs['customertypeHeaderEdit-obj_customertype_id']
const obj_customertype_name = frm.Inputs['customertypeHeaderEdit-obj_customertype_name']	
...
export async function init(self, args) {
	console.log('initializing customertypeHeaderEdit ...')
	...
	// export async function customertypeHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'customertypeHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function customertypeHeaderEdit_isEditDisabled(self, data)
		const fn_iseditdisabled_name = 'customertypeHeaderEdit_isEditDisabled'
		...
		// export async function customertypeHeaderEdit_formOpened(self, frm, CurrentState)
		const fn_formopened_name = 'customertypeHeaderEdit_formOpened'
...
async function backToList(self, evt) {
	...
	if (goback) {
		frm.lock()
		const listId =  Context.Sections.customertypeHeaderList
...
async function  frm_locked(self, evt) {
	...
	// export function customertypeHeaderEdit_formLocked(self, frm, CurrentState) {}
	const fn_name = 'customertypeHeaderEdit_formLocked'
...
async function  frm_unlocked(self, evt) {
	...
	// export function customertypeHeaderEdit_formUnlocked(self, frm, CurrentState) {}
	const fn_name = 'customertypeHeaderEdit_formUnlocked'
	const fn = Extender[fn_name]
	if (typeof fn === 'function') {
		fn(self, frm, CurrentState)
	}
...
async function btn_new_click(self, evt) {
	...
	const customertypeHeaderList = self.Modules.customertypeHeaderList
	const listsecid = customertypeHeaderList.Section.Id
	...
	try {
		...
		const fn_newdata_name = 'customertypeHeaderEdit_newData'
		const fn_newdata = Extender[fn_newdata_name]
		if (typeof fn_newdata === 'function') {
			// export async function customertypeHeaderEdit_newData(self, datainit, frm) {}
		...
		if (fromListSection) {
			...
			self.Modules.customertypeHeaderList.Section.show()
		}
	}
}
...
async function btn_save_click(self, evt) {
	...
	// Extender Autofill
	const fn_autofill_name = 'customertypeHeaderEdit_autofill'
	...
	// Extender Saving
	// export async function customertypeHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	const args = { cancelSave: false }
	const fn_datasaving_name = 'customertypeHeaderEdit_dataSaving'
	...
	try {
		...
		// Extender Saving
		const fn_datasaved_name = 'customertypeHeaderEdit_dataSaved'
		const fn_datasaved = Extender[fn_datasaved_name]
		if (typeof fn_datasaved === 'function') {
			// export async function customertypeHeaderEdit_dataSaved(self, data, frm) {}
		...
		if (isNewData) {
			...
			self.Modules.customertypeHeaderList.addNewRow(self, data)
		} else {
			console.log('update data baris yang dibuka')
			self.Modules.customertypeHeaderList.updateCurrentRow(self, data)
		}
...
async function btn_del_click(self, evt) {
	...
	try {
		...
		self.Modules.customertypeHeaderList.removeCurrentRow(self)
...
async function btn_prev_click(self, evt) {
	...
	self.Modules.customertypeHeaderList.selectPreviousRow(self)
}

async function btn_next_click(self, evt) {
	console.log('btn_next_click')
	self.Modules.customertypeHeaderList.selectNextRow(self)
}
...
async function btn_recordstatus_click(self, evt) {
	...
	pageHelper.openSection(self, 'fRecord-section', params, async ()=>{
		...
		try {
			...
			const fn_addrecordinfo_name = 'customertypeHeaderEdit_addRecordInfo'
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		AboutSection.Title = 'About Customer Type'
