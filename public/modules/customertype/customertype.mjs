...
import * as customertypeHeaderList from './customertypeHeaderList.mjs' 
import * as customertypeHeaderEdit from './customertypeHeaderEdit.mjs' 
import * as Extender from './customertype-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			customertypeHeaderList, 
			customertypeHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				customertypeHeaderList.init(self, args), 
				customertypeHeaderEdit.init(self, args), 
			...
			const modNameList = ['customertypeHeaderEdit']
...
async function render(self) {
	try {
		...
		// customertype-ext.mjs, export function extendPage(self) {} 
