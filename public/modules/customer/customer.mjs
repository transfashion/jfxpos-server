...
import * as customerHeaderList from './customerHeaderList.mjs' 
import * as customerHeaderEdit from './customerHeaderEdit.mjs' 
import * as customerCustomerdiscList from './customerCustomerdiscList.mjs' 
import * as customerCustomerdiscEdit from './customerCustomerdiscEdit.mjs' 
import * as Extender from './customer-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			customerHeaderList, 
			customerHeaderEdit, 
			customerCustomerdiscList, 
			customerCustomerdiscEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				customerHeaderList.init(self, args), 
				customerHeaderEdit.init(self, args), 
				customerCustomerdiscList.init(self, args), 
				customerCustomerdiscEdit.init(self, args), 
			...
			const modNameList = ['customerHeaderEdit', 'customerCustomerdiscEdit']
...
async function render(self) {
	try {
		...
		// customer-ext.mjs, export function extendPage(self) {} 
