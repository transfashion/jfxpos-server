...
const headerTableName = 'public.gender' 	
...
export default class extends Api {
	...
	// extender call
	async execute(body) { return await gender_execute(this, body) }
...
async function gender_execute(self, body) {
	const { fnName } = body
	...
	if (typeof Extender[fnName] === 'function') {
		// export async function [fnName](self, db, body, gender_log) {}
		return await Extender[fnName](self, db, body, gender_log)
	} else {
...
async function gender_headerList(self, body) {
	...
	const searchMap = {
		searchtext: `gender_id = \${searchtext} OR gender_name ILIKE '%' || \${searchtext} || '%'`,
	};
